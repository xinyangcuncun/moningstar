...
public class UIUtils {
    ...
    public static Context getContext() {
        return MsApplication.getContext();
    }
    ...
    public static Handler getMainThreadHandler() {
        return MsApplication.getMainHandler();
    }
    ...
    public static long getMainThreadId() {
        return MsApplication.getMainThreadId();
    }
...
//        navbarheight = getNavBarHeight(context);Log.d(TAG, "screenWidth=" + screenWidth + " screenHeight=" + screenHeight + " density=" + density);
    }
